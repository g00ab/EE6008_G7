...
while len(face_map) < 9:
    print("📸 Scanning face… Detected {} positions.".format(len(face_map)))
    img = sensor.snapshot()
    all_centers = []
    all_boxes = []
...
print("Face complete with 9 positions.")
print_face_3x3(face_map)

time.sleep(2)
new_order = ['white', 'red', 'green', 'yellow', 'blue', 'orange']
